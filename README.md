...
# ... rest of your Dockerfile
```
**Result**: Only builds on branch pushes when Dockerfile or .devcontainer files change, creating `my-devcontainer:v1.0`. No builds on tag pushes or pull requests. Will error if `v1.0` tag already exists.
