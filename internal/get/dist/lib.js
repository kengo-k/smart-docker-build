...
export function extractDockerfileConfig(dockerfilePath, workingDir = process.cwd()) {
...
export async function generateBuildArgs(token, timezone, githubContext, workingDir = process.cwd()) {
    // Validate token
    if (!token || token.trim() === '') {
